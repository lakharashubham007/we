  ...
  return (
    <nav className="mainmenu-nav">
      <ul className="mainmenu">
        ...
        <li className="with-megamenu has-menu-child-item position-static">
          <Link
            className={`${activeMenuItem === "event" ? "open" : ""}`}
            onClick={() => toggleMenuItem("event")}
            href="#"
          >
            Events
            <i className="feather-chevron-down"></i>
          ...
          <div
            className={`rbt-megamenu menu-skin-dark ${activeMenuItem === "event" ? "active d-block" : ""
              }`}
          >
            <div className="wrapper">
              <div className="row row--15 home-plesentation-wrapper single-dropdown-menu-presentation">
